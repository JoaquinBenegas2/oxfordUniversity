...
const ListProfesores = () => {
    ...
    const deleteProfesores = async (cod) => {
        await axios.delete(`http://localhost:4000/profesores/delete/${cod}`)
        getProfesores();
    }
            ...
            <div className="w-full">
                ...
                <div className="w-full flex justify-center">
                    <div className="container">
                        ...
                        <ShowProfesores profesores={profesores} deleteProfesores={deleteProfesores} />
                    </div>
                </div>
            </div>
        </div>
