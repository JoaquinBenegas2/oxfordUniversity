...
const EditAlumnos = () => {
    ...
    const updateAlumno = async (e) => {
        e.preventDefault()
        await axios.put(`http://localhost:4000/alumnos/update/${cod}`, {
            dni_alumno:DNI,
            nom_alumno:nombre,
            ape_alumno:apellido,
            ciu_alumno:ciudad,
                ...
                <div className="flex justify-center">
                    ...
                    <div className="container w-full grid col-8"> 
                        <div className="bg-white p-8 flex col-span-6 shadow-md rounded-25">
                            ...
                            <div className="w-2/5">
                                <div className="card-header-alumnos mb-12 flex items-center h-16">
                                    <p className="text-4xl font-bold text-darkBlue"> Editar Alumno </p>
                                </div>
                                <form className="form" onSubmit={updateAlumno}>
                        ...
                        <div className="bg-white p-8 flex col-span-2 flex-col space-beetwen shadow-md rounded-25">
                            <div>
                                <h1 className="text-5xl text-darkBlue mb-12">¡Edita los datos de <span className="font-bold">{nomMuestra}</span>!</h1>
